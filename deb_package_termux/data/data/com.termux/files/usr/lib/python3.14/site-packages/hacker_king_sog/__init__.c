...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/data/data/com.termux/files/home/hacker_king_sog/deb_package_termux/data/data/com.termux/files/usr/lib/python3.14/site-packages/hacker_king_sog/__init__.py"
        ]
    },
